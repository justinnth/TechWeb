...
if(isset($_COOKIE['categorie'])){
	if($_COOKIE['categorie'] != "all")
		$sql = "select* from article where id_categorie=".$_COOKIE['categorie']." order by rand() limit 3";
}
...
<body>
	...
	<section>
		<header>Bienvenue <span class="ss-titre">Nous sommes le <?= $date ?></span></header>
